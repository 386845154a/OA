...
import cn.gson.oasys.model.entity.product.ProductBase;
...
//				simpleDateFormat.parse(scheduleList.getStartTime()).getTime();  
	...
	public String testIndex(Model model, @RequestParam(value="page",defaultValue="0") int page) {
		System.out.println(page);
		PageHelper.startPage(page, 10);
		model.addAttribute("products", ProductBase.getProducts());
		model.addAttribute("totalPages", ProductBase.getProducts().size());
		return "store/index";
	}
